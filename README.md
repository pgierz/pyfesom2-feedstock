...
Once the `conda-forge` channel has been enabled, `pyfesom2` can be installed with:

```
conda install pyfesom2
```

It is possible to list all of the versions of `pyfesom2` available on your platform with:
